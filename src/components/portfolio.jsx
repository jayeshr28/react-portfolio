            ...
            <div className="col-sm-12">
              <div className="title-box text-center">
                ...
                <p className="subtitle-a">
                  This our some of my work... Take a Look!
                </p>
                  ...
                  <div className="work-content">
                    <div className="row">
                      <div className="col-sm-8">
                        <h2 className="w-title">WhatsApp Custom</h2>
              ...
              <div className="work-box">
                <a href={stock} data-lightbox="gallery-aguadeluz">
                  ...
                  <div className="work-content">
                    <div className="row">
                      <div className="col-sm-8">
                        <h2 className="w-title">Farmers Welfare</h2>
                        <div className="w-more">
                          <span className="w-ctegory">
              ...
              <div className="work-box">
                <a href={stock} data-lightbox="gallery-todo">
                  ...
                  <div className="work-content">
                    <div className="row">
                      <div className="col-sm-8">
                        <h2 className="w-title">Pomodoro-Be Productive</h2>
                        <div className="w-more">
                          <span className="w-ctegory">
                            Flutter, Dart, Music Player
                          </span>
              ...
              <div className="work-box">
                <a href={stock} data-lightbox="gallery-smth">
                  ...
                  <div className="work-content">
                    <div className="row">
                      <div className="col-sm-8">
                        <h2 className="w-title">Crypto Wallet</h2>
                        <div className="w-more">
              ...
              <div className="work-box">
                <a href={stock} data-lightbox="gallery-mf">
                  ...
                  <div className="work-content">
                    <div className="row">
                      <div className="col-sm-8">
                        <h2 className="w-title">Personal Expense Tracker</h2>
                        <div className="w-more">
                          <span className="w-ctegory">
